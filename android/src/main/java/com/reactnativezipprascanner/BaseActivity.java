...
import static  com.reactnativezipprascanner.helpers.Constants.VIRTUAL_TETHER_HOST_BACKGROUND_MODE_NOTIFICATION;
...
import  com.reactnativezipprascanner.helpers.AvailableScanner;
...
public class BaseActivity extends ReactActivity implements ScannerAppEngine, IDcsSdkApiDelegate {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Constants.BARCODE_RECEIVED:
                    Toast.makeText(getApplicationContext(), "Barcode Received", Toast.LENGTH_SHORT).show();
                    ...
                    if (!Application.isFirmwareUpdateInProgress) {
                        if (Application.currentScannerId != Application.SCANNER_ID_NONE) {
                            ...
                            intent.setComponent(new ComponentName(getPackageName(), ActiveSanner.class.getName()));
                ...
                case Constants.SESSION_ESTABLISHED:
                    ...
                    result = false;
//                    ActiveSanner.curAvailableScanner = new AvailableScanner(activeScanner);
