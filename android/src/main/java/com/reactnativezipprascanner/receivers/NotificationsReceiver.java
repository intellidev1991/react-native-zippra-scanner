package com.reactnativezipprascanner.receivers;
...
import com.reactnativezipprascanner.ZippraScannerModule;
...
//
        ...
        Toast.makeText(ZippraScannerModule.MainContext, "Hello", Toast.LENGTH_SHORT).show();
